...
#ifdef _DEBUG
//HACK: uncomment this to enable warnings//#undef  EWRAPPERL0_DEFAULT
//HACK: uncomment this to enable warnings//#define EWRAPPERL0_DEFAULT(id, name) printf( "#warning: empty default method EWrapperL0::%s(id=%ld) was called!\n", name, static_cast<long int>(id) );
#endif
#endif
