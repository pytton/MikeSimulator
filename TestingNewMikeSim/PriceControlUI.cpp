...
void PriceControlUI::m_down_btn_cb(Fl_Widget * buttonPressed, void * p)
{
	...
	myPriceControlUI->getControl()->CallbkPriceControlUI(myPriceControlUI, BtnPressed::DOWNBTN, buttonPressed);
}

void PriceControlUI::m_up_btn_cb(Fl_Widget * buttonPressed, void * p)
{
	PriceControlUI * myPriceControlUI = (PriceControlUI*)p;
	myPriceControlUI->m_pControl->CallbkPriceControlUI(myPriceControlUI, BtnPressed::UPBTN, buttonPressed);
}

void PriceControlUI::m_slider1_cb(Fl_Widget * slider1Pointer, void * p)
{
	PriceControlUI * myPriceControlUI = (PriceControlUI*)p;
	myPriceControlUI->m_pControl->CallbkPriceControlUI(myPriceControlUI, BtnPressed::SLIDER1, slider1Pointer);
}

void PriceControlUI::m_btnPrint_cb(Fl_Widget * buttonPressed, void * p)
{
	PriceControlUI * myPriceControlUI = (PriceControlUI*)p;
	myPriceControlUI->m_pControl->CallbkPriceControlUI(myPriceControlUI, BtnPressed::PRINTBUT, buttonPressed);
}

void PriceControlUI::m_btnLiveDataConsolePrint_cb(Fl_Widget * buttonPressed, void * p)
{
	PriceControlUI * myPriceControlUI = (PriceControlUI*)p;
	myPriceControlUI->m_pControl->CallbkPriceControlUI(myPriceControlUI, BtnPressed::LIVEDATACONSOLEPRINTOUT, buttonPressed);
}

void PriceControlUI::m_btnConnectLiveData_cb(Fl_Widget * buttonPressed, void * p)
{
	PriceControlUI * myPriceControlUI = (PriceControlUI*)p;
	myPriceControlUI->m_pControl->CallbkPriceControlUI(myPriceControlUI, BtnPressed::CONNECTLIVEDATA, buttonPressed);
}
